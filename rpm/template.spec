...
%global pkg_name gz_fuel_tools_vendor
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-gz-fuel-tools-vendor
Version:        0.3.1
Release:        3%{?dist}
...
%description
Vendor package for: gz-fuel_tools 11.0.0 Gazebo Fuel Tools: Classes and tools
...
%changelog
* Wed Apr 29 2026 Addisu Z. Taddese <addisuzt@intrinsic.ai> - 0.3.1-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Addisu Z. Taddese <addisuzt@intrinsic.ai> - 0.3.1-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Addisu Z. Taddese <addisuzt@intrinsic.ai> - 0.3.1-1
- Autogenerated by Bloom
