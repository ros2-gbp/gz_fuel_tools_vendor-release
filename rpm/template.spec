...
Name:           ros-rolling-gz-fuel-tools-vendor
Version:        0.4.1
Release:        1%{?dist}
...
%description
Vendor package for: gz-fuel_tools 12.0.0 Gazebo Fuel Tools: Classes and tools
...
%changelog
* Tue Aug 25 2026 Addisu Z. Taddese <addisuzt@intrinsic.ai> - 0.4.1-1
